...
namespace Russo2
{
    public partial class telaGrafP : Form
    {
        public telaGrafP()
        {
            InitializeComponent();
    ...
    private void telaGrafP_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (objCnx.State == ConnectionState.Open)
                {
                    ...
                    switch (vendedor)
                    {
                        case "1":
                            //MÊS DE JANEIRO-------------------------------------------------------------------------------------------
                            mAdapter1 = new MySqlDataAdapter("SELECT COUNT(*) as qtd FROM tbpros WHERE proVendedor = 'vendas1' and promes = '1';", objCnx);
                            ...
                            //MÊS DE FEVEREIRO-------------------------------------------------------------------------------------------
                            mAdapter2 = new MySqlDataAdapter("SELECT COUNT(*) as qtd FROM tbpros WHERE proVendedor = 'vendas1' and promes = '2';", objCnx);
                            ...
                            //MÊS DE MARÇO-------------------------------------------------------------------------------------------
                            mAdapter3 = new MySqlDataAdapter("SELECT COUNT(*) as qtd FROM tbpros WHERE proVendedor = 'vendas1' and promes = '3';", objCnx);
                            ...
                            //MÊS DE ABRIL-------------------------------------------------------------------------------------------
                            mAdapter4 = new MySqlDataAdapter("SELECT COUNT(*) as qtd FROM tbpros WHERE proVendedor = 'vendas1' and promes = '4';", objCnx);
                            ...
                            //MÊS DE MAIO-------------------------------------------------------------------------------------------
                            mAdapter5 = new MySqlDataAdapter("SELECT COUNT(*) as qtd FROM tbpros WHERE proVendedor = 'vendas1' and promes = '5';", objCnx);
                        ...
                        case "4":
                            //MÊS DE JANEIRO-------------------------------------------------------------------------------------------
                            mAdapter1 = new MySqlDataAdapter("SELECT COUNT(*) as qtd FROM tbpros WHERE proVendedor = 'vendas4' and promes = '1';", objCnx);
                            mAdapter1.Fill(dat1, "tbProspec");
                            ...
                            //MÊS DE FEVEREIRO-------------------------------------------------------------------------------------------
                            mAdapter2 = new MySqlDataAdapter("SELECT COUNT(*) as qtd FROM tbpros WHERE proVendedor = 'vendas4' and promes = '2';", objCnx);
                            mAdapter2.Fill(dat2, "tbProspec");
                            ...
                            //MÊS DE MARÇO-------------------------------------------------------------------------------------------
                            mAdapter3 = new MySqlDataAdapter("SELECT COUNT(*) as qtd FROM tbpros WHERE proVendedor = 'vendas4' and promes = '3';", objCnx);
                            mAdapter3.Fill(dat3, "tbProspec");
                            ...
                            //MÊS DE ABRIL-------------------------------------------------------------------------------------------
                            mAdapter4 = new MySqlDataAdapter("SELECT COUNT(*) as qtd FROM tbpros WHERE proVendedor = 'vendas4' and promes = '4';", objCnx);
                            mAdapter4.Fill(dat4, "tbProspec");
                            ...
                            //MÊS DE MAIO-------------------------------------------------------------------------------------------
                            mAdapter5 = new MySqlDataAdapter("SELECT COUNT(*) as qtd FROM tbpros WHERE proVendedor = 'vendas4' and promes = '5';", objCnx);
                            mAdapter5.Fill(dat5, "tbProspec");
                            ...
                            //MÊS DE JUNHO-------------------------------------------------------------------------------------------
                            mAdapter6 = new MySqlDataAdapter("SELECT COUNT(*) as qtd FROM tbpros WHERE proVendedor = 'vendas4' and promes = '6';", objCnx);
                            mAdapter6.Fill(dat6, "tbProspec");
                            ...
                            //MÊS DE JULHO------------------------------------------------------------------------------------------
                            mAdapter7 = new MySqlDataAdapter("SELECT COUNT(*) as qtd FROM tbpros WHERE proVendedor = 'vendas4' and promes = '7';", objCnx);
                            mAdapter7.Fill(dat7, "tbProspec");
                            ...
                            //MÊS DE JULHO------------------------------------------------------------------------------------------
                            mAdapter8 = new MySqlDataAdapter("SELECT COUNT(*) as qtd FROM tbpros WHERE proVendedor = 'vendas4' and promes = '8';", objCnx);
                            mAdapter8.Fill(dat8, "tbProspec");
                            ...
                            //MÊS DE JULHO------------------------------------------------------------------------------------------
                            mAdapter9 = new MySqlDataAdapter("SELECT COUNT(*) as qtd FROM tbpros WHERE proVendedor = 'vendas4' and promes = '9';", objCnx);
                            mAdapter9.Fill(dat9, "tbProspec");
                            ...
                            //MÊS DE JULHO------------------------------------------------------------------------------------------
                            mAdapter10 = new MySqlDataAdapter("SELECT COUNT(*) as qtd FROM tbpros WHERE proVendedor = 'vendas4' and promes = '10';", objCnx);
                            mAdapter10.Fill(dat10, "tbProspec");
                            ...
                            //MÊS DE JULHO------------------------------------------------------------------------------------------
                            mAdapter11 = new MySqlDataAdapter("SELECT COUNT(*) as qtd FROM tbpros WHERE proVendedor = 'vendas4' and promes = '11';", objCnx);
                            mAdapter11.Fill(dat11, "tbProspec");
                            ...
                            //MÊS DE JULHO------------------------------------------------------------------------------------------
                            mAdapter12 = new MySqlDataAdapter("SELECT COUNT(*) as qtd FROM tbpros WHERE proVendedor = 'vendas4' and promes = '12';", objCnx);
                            mAdapter12.Fill(dat12, "tbProspec");
                        ...
                        case "5":
                            //MÊS DE JANEIRO-------------------------------------------------------------------------------------------
                            mAdapter1 = new MySqlDataAdapter("SELECT COUNT(*) as qtd FROM tbpros WHERE proVendedor = 'adm' and promes = '1';", objCnx);
                            mAdapter1.Fill(dat1, "tbProspec");
                            ...
                            //MÊS DE FEVEREIRO-------------------------------------------------------------------------------------------
                            mAdapter2 = new MySqlDataAdapter("SELECT COUNT(*) as qtd FROM tbpros WHERE proVendedor = 'adm' and promes = '2';", objCnx);
                            mAdapter2.Fill(dat2, "tbProspec");
                            ...
                            //MÊS DE MARÇO-------------------------------------------------------------------------------------------
                            mAdapter3 = new MySqlDataAdapter("SELECT COUNT(*) as qtd FROM tbpros WHERE proVendedor = 'adm' and promes = '3';", objCnx);
                            mAdapter3.Fill(dat3, "tbProspec");
                            ...
                            //MÊS DE ABRIL-------------------------------------------------------------------------------------------
                            mAdapter4 = new MySqlDataAdapter("SELECT COUNT(*) as qtd FROM tbpros WHERE proVendedor = 'adm' and promes = '4';", objCnx);
                            mAdapter4.Fill(dat4, "tbProspec");
                            ...
                            //MÊS DE MAIO-------------------------------------------------------------------------------------------
                            mAdapter5 = new MySqlDataAdapter("SELECT COUNT(*) as qtd FROM tbpros WHERE proVendedor = 'adm' and promes = '5';", objCnx);
                            mAdapter5.Fill(dat5, "tbProspec");
        ...
        {
            string pathImage = Environment.CurrentDirectory + "\\saleChart.png";
            chart1.SaveImage(pathImage, ChartImageFormat.Png);

            MessageBox.Show("Grafico salvo");
        }
